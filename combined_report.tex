...
\begin{titlepage}
    ...
    {\large
    \textbf{Repository:} \href{https://github.com/japneet1234/NLU_PA-2?tab=readme-ov-file}{github.com/japneet1234/NLU\_PA-2}\\[4pt]
    \textbf{Project Page:} \href{https://japneet1234.github.io/NLU_PA-2/}{japneet1234.github.io/NLU\_PA-2/}\par}
...
\centering
\captionof{table}{Problem 1 Corpus Statistics}
\begin{tabular}{l c}
\toprule
...
\begin{minipage}[t]{0.48\textwidth}
\centering
\captionof{table}{Top-10 Most Frequent Tokens}
\begin{tabular}{l c}
\toprule
...
\begin{table}[H]
\centering
\caption{Nearest Neighbors Comparison (Top-5)}
\small
\begin{tabular}{p{1.8cm} p{6.2cm} p{6.2cm}}
\toprule
\textbf{Query} & \textbf{CBOW} & \textbf{Skip-gram} \\
\midrule
research & researcher, award, collaboration, work, career & hnology, florida, cuttingedge, undertaking, attracting \\
student & program, various, career, team, member & udents, studen, stud, sophomore, tudents \\
phd & mtech, mmt, msc, amd, jpd & mtech, jpd, mtechphd, reject, resubmit \\
exam & cancel, asked, decide, clearing, spend & anxiety, guardian, satisfactorily, cleared, converted \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{report_assets/prob1_cell13_img1.png}
        \caption{t-SNE projection for CBOW embeddings}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{report_assets/prob1_cell13_img2.png}
        \caption{t-SNE projection for Skip-gram embeddings}
    \end{subfigure}
    \caption{t-SNE comparison of CBOW and Skip-gram embeddings}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{report_assets/prob1_cell15_img1.png}
        \caption{PCA projection for CBOW embeddings}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{report_assets/prob1_cell15_img2.png}
        \caption{PCA projection for Skip-gram embeddings}
    \end{subfigure}
    \caption{PCA comparison of CBOW and Skip-gram embeddings}
\end{figure}
