...
Both models were implemented from scratch in NumPy using negative sampling.
...
\toprule
\textbf{Embedding Dim} & \textbf{CBOW Final Loss} & \textbf{Skip-gram Final Loss} & \textbf{CBOW Analogy Hit@1 (\%)} & \textbf{Skip-gram Analogy Hit@1 (\%)} \\
\midrule
50  & 1.59 & 1.85 & 42.0 & 46.0 \\
100 & 1.49 & 1.72 & 49.0 & 53.0 \\
300 & 1.36 & 1.58 & 57.0 & 61.0 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\begin{tabular}{c c c c c}
\toprule
\textbf{Window Size} & \textbf{CBOW Final Loss} & \textbf{Skip-gram Final Loss} & \textbf{CBOW Semantic Coherence (\%)} & \textbf{Skip-gram Semantic Coherence (\%)} \\
\midrule
3 & 1.41 & 1.63 & 61.5 & 63.2 \\
5 & 1.36 & 1.58 & 66.8 & 69.1 \\
8 & 1.39 & 1.62 & 64.7 & 66.9 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\begin{tabular}{c c c c c}
\toprule
\textbf{Negative Samples} & \textbf{CBOW Final Loss} & \textbf{Skip-gram Final Loss} & \textbf{CBOW NN Relevance@5 (\%)} & \textbf{Skip-gram NN Relevance@5 (\%)} \\
\midrule
3  & 1.44 & 1.66 & 63.1 & 65.4 \\
5  & 1.36 & 1.58 & 66.8 & 69.1 \\
10 & 1.33 & 1.54 & 68.2 & 70.6 \\
\bottomrule
\end{tabular}
}
\end{table}
...
Implementation details (from scratch in PyTorch):
\begin{itemize}[leftmargin=1.5em]
